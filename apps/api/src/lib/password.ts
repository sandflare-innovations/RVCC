...
/*
 * Same scrypt encoding as apps/admin/src/lib/password.ts (`scrypt$N$r$p$salt$hash`).
 * Keep the two copies identical so hashes created by create-admin still verify here.
 */
function scrypt(
  password: string,
  salt: Buffer,
