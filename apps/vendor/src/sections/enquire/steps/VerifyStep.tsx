  ...
  const verifyCode = async () => {
    ...
    try {
      ...
      if (outcome === "rejected") {
        ...
        setGateMessage(
          data.message ||
            "Your registration was not approved. Contact RVCC procurement for help."
        );
    ...
    return (
      <div className="max-w-lg space-y-8">
        ...
        <EnquireActions>
          ...
          <a href="/login" className="text-brand-blue text-sm font-semibold underline underline-offset-2">
            Password sign-in
          </a>
        </EnquireActions>
      </div>
        ...
        <div className="flex items-start gap-4 rounded-lg border border-zinc-200 bg-zinc-50 px-5 py-5">
          ...
          <div className="min-w-0 space-y-1">
            ...
            <p className={enquireMutedClass}>
              ...
              <span className="font-semibold text-zinc-800">{registration!.email}</span>. Progress is
              saved in this browser until you submit or log out.
            </p>
          </div>
        </div>
        <EnquireActions>
