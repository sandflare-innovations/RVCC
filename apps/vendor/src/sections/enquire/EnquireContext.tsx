...
function mergePayload(
  ...
  if (typeof payload.company === "object" && payload.company) {
    next.company = { ...(prev.company || emptyDraft(prev.email).company!), ...payload.company } as DraftRegistration["company"];
  }
  if (Array.isArray(payload.contacts)) next.contacts = payload.contacts as DraftRegistration["contacts"];
  if (Array.isArray(payload.addresses)) next.addresses = payload.addresses as DraftRegistration["addresses"];
