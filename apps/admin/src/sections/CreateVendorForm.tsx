  ...
  return (
    <>
      <button
        ...
        className="bg-brand-blue hover:bg-brand-blue/90 mb-6 inline-flex h-11 items-center gap-2 rounded-lg px-5 text-sm font-semibold text-white shadow-sm transition-all hover:shadow focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none"
      >
