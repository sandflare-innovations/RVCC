...
import { ClipboardList, Plus, LayoutDashboard, Users, FileText } from "lucide-react";
...
export default function NotFound() {
  return (
    <NotFoundPage
      ...
      isAuthenticated
      suggestions={[
        { label: "All Requirements", href: "/requirements", icon: <ClipboardList className="h-5 w-5" /> },
