    ...
    <div className="flex flex-col min-h-0 w-full h-full relative">
      ...
      <div className="flex-1 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        <div className="flex flex-col items-center justify-center py-24 text-center">
          <div className="h-20 w-20 rounded-2xl bg-purple-50 flex items-center justify-center mb-6 border border-purple-100">
          ...
          <p className="text-sm text-zinc-500 max-w-md leading-relaxed">
            The gallery management module is under development. You&apos;ll be able to upload, organize, and manage all gallery images and collections.
          </p>
          <div className="mt-8 flex flex-wrap gap-3 justify-center">
            <span className="bg-zinc-100 text-zinc-600 text-xs font-medium px-3 py-1.5 rounded-full">Upload Images</span>
            <span className="bg-zinc-100 text-zinc-600 text-xs font-medium px-3 py-1.5 rounded-full">Create Collections</span>
            <span className="bg-zinc-100 text-zinc-600 text-xs font-medium px-3 py-1.5 rounded-full">Reorder Photos</span>
          </div>
        </div>
      </div>
    </div>
