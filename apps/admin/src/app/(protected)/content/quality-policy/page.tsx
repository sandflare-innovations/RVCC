import { ChevronLeft, Construction,ShieldCheck } from "lucide-react";
    ...
    <div className="relative flex h-full min-h-0 w-full flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500">
                Manage quality policy and compliance information
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 [scrollbar-width:none] overflow-y-auto [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
        <div className="flex flex-col items-center justify-center py-24 text-center">
          <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-2xl border border-teal-100 bg-teal-50">
          ...
          <p className="max-w-md text-sm leading-relaxed text-zinc-500">
            The quality policy management module is under development. You&apos;ll be able to edit
            the quality policy content and compliance details shown on the website.
          </p>
