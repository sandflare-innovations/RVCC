...
/**
 * Shown when a new service worker is waiting. Gives users a clear action
 * before the automatic reload on controller change.
 */
    ...
    >
      <div className="pointer-events-auto flex w-full max-w-lg items-center justify-between gap-4 rounded-2xl border border-zinc-200 bg-white px-4 py-3 shadow-lg">
        <div className="min-w-0">
          ...
          <p className="text-xs text-zinc-500">A newer version of RVCC Admin is ready.</p>
        </div>
        <button
          type="button"
          disabled={applying}
