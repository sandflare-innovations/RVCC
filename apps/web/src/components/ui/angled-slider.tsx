...
const AngledCard = ({
  ...
  return (
    ...
    >
      {/* The Image Card */}
      <div className="bg-muted relative h-full min-h-[300px] w-full overflow-hidden border border-white/10 shadow-2xl">
        <Image
          src={item.url}
        ...
        {item.title && (
          <div className="absolute right-0 bottom-0 left-0 bg-gradient-to-t from-black/80 to-transparent p-4 text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
