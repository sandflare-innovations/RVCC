    ...
    >
      <div className="pointer-events-auto flex w-full max-w-lg items-center justify-between gap-4 rounded-2xl border border-zinc-200 bg-white px-4 py-3 shadow-lg">
        <div className="min-w-0">
          ...
          <p className="text-xs text-zinc-500">A newer version of RVCC is ready.</p>
        </div>
        <button
          type="button"
          disabled={applying}
          ...
          className="inline-flex shrink-0 items-center gap-2 rounded-full bg-[#0073bc] px-4 py-2 text-xs font-bold text-white transition-opacity hover:opacity-90 disabled:opacity-60"
        >
