...
const NAV = [
  { href: "/admin", label: "Dashboard", icon: <LayoutDashboard className={ICON} />, exact: true },
  {
    href: "/admin/registrations",
    label: "Vendor Registrations",
    icon: <FileText className={ICON} />,
  },
  { href: "/admin/vendors", label: "Vendor Accounts", icon: <Users className={ICON} /> },
  { href: "/admin/content", label: "Site Content", icon: <FolderOpen className={ICON} /> },
];
