...
export function StepTrain({ current, unlockedThrough, emailVerified = false }: Props) {
  ...
  return (
    <nav aria-label="Registration steps" className="h-full min-h-[400px] w-full">
            ...
            <div className="relative">
              ...
              <span
                className={cn(
                  ...
                  active
                    ? "text-brand-blue border-white bg-white shadow-md"
                    : done
          ...
          return (
            <li
              ...
              className={cn(
                ...
                index < VISIBLE.length - 1 ? "flex-1 pb-4" : ""
              )}
            >
              ...
              {index < VISIBLE.length - 1 && (
                <div
                  className={cn(
                    "absolute top-8 bottom-0 left-[15px] w-[2px]",
              ...
              <div className="relative z-10 shrink-0">
                {unlocked ? (
                  <Link
                    ...
                    className="focus-visible:ring-offset-brand-blue block rounded-full focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:outline-none"
                  >
                    {bubble}
                  </Link>
                ) : (
