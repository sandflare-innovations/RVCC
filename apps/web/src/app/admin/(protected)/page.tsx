...
const CARDS = [
  { key: "SUBMITTED", label: "Awaiting review", href: "/admin/registrations?status=SUBMITTED" },
  { key: "APPROVED", label: "Approved", href: "/admin/registrations?status=APPROVED" },
  { key: "REJECTED", label: "Rejected", href: "/admin/registrations?status=REJECTED" },
  { key: "DRAFT", label: "In progress", href: "/admin/registrations?status=DRAFT" },
] as const;
